...
set proj_name link_engine_regs
...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/doc/link_engine_regs.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/doc/link_engine_regs.qip
set_property "top" "link_engine_regs" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force link_engine_regs_synth.dcp
