...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/link_fifo.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/link_fifo.qip
set_property "top" "link_fifo" $obj

set_property generic { LINK_FIFO_DEPTH=1024 } [current_fileset]
set_property generic { LINK_FIFO_DATA_WIDTH=256 } [current_fileset]
set_property generic { LINK_FIFO_ADDR_WIDTH=10 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force link_fifo_synth.dcp
