...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/common/vi_lib/vi_sync_level.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/common/vi_lib/vi_sync_level.qip
set_property "top" "vi_sync_level" $obj
set_property generic { TWO_DST_FLOPS=1 } [current_fileset]
set_property generic { SIZE=1 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force vi_sync_level_synth.dcp
