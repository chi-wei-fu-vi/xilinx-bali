...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/interval_stats.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/interval_stats.qip
set_property "top" "interval_stats" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force interval_stats_synth.dcp
