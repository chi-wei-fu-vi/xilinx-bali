...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/ucstats_read.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/ucstats_read.qip
set_property "top" "ucstats_read" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force ucstats_read_synth.dcp
