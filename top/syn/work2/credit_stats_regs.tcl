...
set proj_name credit_stats_regs
...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/doc/credit_stats_regs.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/doc/credit_stats_regs.qip
set_property "top" "credit_stats_regs" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force credit_stats_regs_synth.dcp
