...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/channel_engine.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/channel_engine.qip
set_property "top" "channel_engine" $obj
set_property generic { SIM_ONLY=0 } [current_fileset]
set_property generic { CH_ID=1 } [current_fileset]
set_property generic { LINK_ID=0 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force channel_engine_synth.dcp
