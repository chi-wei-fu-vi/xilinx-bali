...
set proj_name link_addr_decoder
...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/link_addr_decoder.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/link_addr_decoder.qip
set_property "top" "link_addr_decoder" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force link_addr_decoder_synth.dcp
