...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/ts_fifo_wrap.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/ts_fifo_wrap.qip
set_property "top" "ts_fifo_wrap" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force ts_fifo_wrap_synth.dcp
