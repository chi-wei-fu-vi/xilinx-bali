...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/gatekeeper.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/link_engine/rtl/gatekeeper.qip
set_property "top" "gatekeeper" $obj
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force gatekeeper_synth.dcp
