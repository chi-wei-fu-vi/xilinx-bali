...
set ::quartus(qip_path) [ file normalize [ file dirname /home/chiwei/work/checkout/xilinx-bali.git.new/fmac/rtl/fmac_wrap.qip ] ]
source /home/chiwei/work/checkout/xilinx-bali.git.new/fmac/rtl/fmac_wrap.qip
set_property "top" "fmac_wrap" $obj
set_property generic { SIM_ONLY=0 } [current_fileset]
set_property generic { CH_ID=0 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force fmac_wrap_synth.dcp
