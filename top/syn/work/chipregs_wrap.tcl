...
set_property "top" "chipregs_wrap" $obj
set_property generic { pFSPEEDGRADE=8'h02 } [current_fileset]
set_property generic { pGBLTIMESTAMPRST=1'b1 } [current_fileset]
set_property generic { pNUMPCIELANES=8'd8 } [current_fileset]
set_property generic { pBISTPCIE1=1'd0 } [current_fileset]
set_property generic { pBISTPCIE0=1'd1 } [current_fileset]
set_property generic { pLITE=0 } [current_fileset]
set_property generic { pPCIEGENMAX=4'd2 } [current_fileset]
set_property generic { pXCVRSPEEDMAX=12'd8 } [current_fileset]
set_property generic { pNUMXCVR=CHANNELS } [current_fileset]
set_property generic { pNUMDPLBUF=4'd12 } [current_fileset]
set_property generic { pFVENDOR=16'h0a17 } [current_fileset]
set_property generic { pNUMPCIEEP=4'd1 } [current_fileset]
set_property generic { pPROTOCOL=4'd1 } [current_fileset]
set_property generic { pFPACKAGE=24'hA90F40 } [current_fileset]
set_property generic { pFSERDESGRADE=8'h01 } [current_fileset]
set_property generic { pXBAR=1'd0 } [current_fileset]
set_property generic { pBISTPRBSXCVR=1'd1 } [current_fileset]
set_property generic { pFFAMILY=16'h0055 } [current_fileset]
set_property generic { pNUMLINKENGINES=4'd12 } [current_fileset]
set_property generic { pBISTTX32B=1'd1 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force chipregs_wrap_synth.dcp
