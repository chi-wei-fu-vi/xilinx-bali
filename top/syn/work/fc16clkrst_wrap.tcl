...
set_property "top" "fc16clkrst_wrap" $obj
set_property generic { pCNT_CMP_THRESH=1973790 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force fc16clkrst_wrap_synth.dcp
