...
set_property "top" "heartbeat_x4" $obj
set_property generic { heartbeat_mode=1 } [current_fileset]
set_property generic { lfsr_seed=1 } [current_fileset]
set_property generic { led_width=4 } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force heartbeat_x4_synth.dcp
