...
set_property "top" "fc1_kr_wrap" $obj
set_property generic { CHANNELS=26 } [current_fileset]
set_property generic { LINKS=LINKS + CROSSLINK } [current_fileset]
...
wait_on_run synth_1
open_run synth_1
write_checkpoint -force fc1_kr_wrap_synth.dcp
